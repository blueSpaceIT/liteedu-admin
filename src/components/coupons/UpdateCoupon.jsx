...
import { useUpdateCouponMutation } from "../../redux/features/api/coupons/couponsApi";
import useFormSubmit from "../../hooks/useFormSubmit";
import { toast } from "react-toastify";
import { useState } from "react";

const UpdateCoupon = ({ initialData, close }) => {
    const [loading, setLoading] = useState(false);
    const [updateCoupon] = useUpdateCouponMutation(initialData._id);
    ...
    const {
    ...
    } = useForm(
        {
            defaultValues: {
                ...
                discountAmount: initialData?.discountAmount !== "" ? Number(initialData.discountAmount) : null,
