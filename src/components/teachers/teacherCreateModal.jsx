    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="max-h-[90vh] w-[90%] max-w-2xl overflow-y-auto rounded-lg bg-white p-6 shadow-xl dark:bg-gray-900">
                <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create Teacher</h2>
                ...
                >
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                        <div className="flex flex-1 flex-col">
                            <label className="mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Address</label>
                            <input
                                type="text"
                                name="address"
                        ...
                        <div className="flex flex-1 flex-col">
                            <label className="mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Gender</label>
                            <select
                                name="gender"
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                        {[
                            ...
                            <div
                                ...
                                className="flex flex-1 flex-col"
                            >
                                <label className="mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">{field.label}</label>
                                <input
                                    type="text"
                                    name={field.name}
